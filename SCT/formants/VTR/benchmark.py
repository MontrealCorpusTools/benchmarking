...
if __name__ == '__main__':
	...
	corpus_dir_1 = '/Users/mlml/Documents/transfer/' + corpus_name + '/Test'
	corpus_dir_2 = '/Users/mlml/Documents/transfer/' + corpus_name + '/Train'
	...
	now = datetime.now()
	clocktime = str(now.hour) + str(now.minute) + str(now.second)
